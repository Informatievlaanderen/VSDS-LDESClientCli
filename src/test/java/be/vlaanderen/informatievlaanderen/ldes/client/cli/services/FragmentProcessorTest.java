...
class FragmentProcessorTest {
    ...
    void when_LdesServerHasFragments_TheyAreConvertedAndPrintedOut() throws IOException, URISyntaxException {
        ...
        be.vlaanderen.informatievlaanderen.ldes.client.cli.services.FragmentProcessor fragmentProcessor = new be.vlaanderen.informatievlaanderen.ldes.client.cli.services.FragmentProcessor(ldesService, printStream, Lang.NQUADS);
    ...
    void when_LdesServerHasNoFragments_NothingIsPrinted() throws IOException {
        ...
        be.vlaanderen.informatievlaanderen.ldes.client.cli.services.FragmentProcessor fragmentProcessor = new FragmentProcessor(ldesService, printStream, null);
        fragmentProcessor.processLdesFragments();
